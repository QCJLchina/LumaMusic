...
- 本项目采用 [MIT 许可证](LICENSE) 开源：可自由使用、修改、分发，商用亦可，只需保留版权声明与许可证原文。BASS 库版权归 [un4seen](https://www.un4seen.com/) 所有，由构建脚本从官方下载，本仓库不包含其任何文件。第三方组件详见 [THIRD-PARTY-NOTICES.md](THIRD-PARTY-NOTICES.md)。
